...
if (!function_exists('updateTierForBusiness')) {
    function updateTierForBusiness($business)
    {
        $tiers = Tier::all();
        if (count($tiers)) {
            foreach ($tiers as $key => $tier) {
                ...
                $tierPercentage = 0;
                foreach ($tier->achievements as $n) {
                    $tierPercentage += $business->achievementProgressPercentage(new $n->class_name());
                }
                $tierPercentage = ($tierPercentage > 0) ? ($tierPercentage / 10) : 0;

                if ($tierPercentage >= 100) {
                    $business->tier_id = $tier->id;
                    $business->save();
                }
            }
        }
...
if (!function_exists('avgRatings')) {
    ...
    {
        $value = $categories = \App\Models\Rating::where('post_id', $post_id)->where('type', $type)->avg('rating');
        if ($value == null) {
            return 0;
        } else {
            return $value;
...
if (!function_exists('checkWishlist')) {
    ...
    function checkWishlist($id)
    {
        ...
        if (Auth::check()) {
            $wish_check = \App\Models\Wishlist::where('course_id', $id)->where('user_id', Auth::user()->id)->first();
            if ($wish_check) {
                return true;
            } else {
                return false;
...
if (!function_exists('totalRatings')) {
    ...
    {
        return $categories = \App\Models\Rating::where('post_id', $post_id)->where('type', $type)->get();
    }
}
...
if (!function_exists('getUploads')) {
    ...
    {
        return $categories = \App\Models\CourseUpload::where('course_id', $course_id)->get();
    }
}
...
if (!function_exists('totalCourses')) {
    ...
    {
        return $categories = \App\Models\Course::where('status', 1)->count();
    }
}
...
if (!function_exists('totalCompanies')) {
    ...
    {
        return $categories = \App\Models\Company::where('status', 1)->count();
    }
}
...
if (!function_exists('totalTrainers')) {
    ...
    {
        return $categories = \App\Models\User::where('user_type', 'trainer')->count();
    }
}
...
if (!function_exists('checkPurchase')) {
    ...
    {
        return $categories = \App\Models\Order::where('user_id', $user_id)->where('course_id', $course_id)->first();
    }
}
...
if (!function_exists('getRating')) {
    ...
    {
        return $categories = \App\Models\Rating::where('user_id', $user_id)->where('post_id', $post_id)->first();
    }
}
...
if (!function_exists('getMenuItem')) {
    ...
    {
        return $categories = \App\Models\MenuItem::where('id', $id)->first();
    }
}
...
if (!function_exists('getLanguage')) {
    ...
    {
        return $categories = \App\Models\AllLanguage::where('id', $id)->first();
    }
}
...
if (!function_exists('getInstitute')) {
    ...
    {
        return $categories = \App\Models\Institute::where('id', $id)->first();
    }
}
...
if (!function_exists('chkBidding')) {
    ...
    {
        return $categories = \App\Models\Bidding::where('course_id', $id)->where('company_id', $company_id)->first();
    }
}
...
if (!function_exists('getHomeBanner')) {
    ...
    {
        return $categories = \App\Models\HomePageSection::where('slug', $slug)->first();
    }
}
...
if (!function_exists('getHomeBannerImg')) {
    ...
    {
        return $categories = \App\Models\HomeBanner::where('page_id', $id)->first();
    }
}
...
if (!function_exists('getPageSection')) {
    ...
    {
        return $categories = \App\Models\Page::where('menu_item_id', $item)->where('menu_section_id', $section)->first();
    }
}
...
if (!function_exists('getMenuSection')) {
    ...
    {
        return $categories = \App\Models\MenuSection::where('id', $id)->first();
    }
}
...
if (!function_exists('getCompanyCount')) {
    ...
    {
        $subCat = \App\Models\Company::count();
        return $subCat;
    }
}
...
if (!function_exists('company_positions')) {
    function company_positions()
    {
        ...
        $optnList   = '';
        $optionArr = \App\Models\CompanyPosition::select('id', 'position_en', 'position_ar')
...
if (!function_exists('company_departments')) {
    function company_departments()
    {
        $company_id = Session::get('company_id');
        $optnList   = '';
        $optionArr = \App\Models\CompanyDepartment::where('company_id', $company_id)
...
if (!function_exists('company_projects')) {
    function company_projects()
    {
        $company_id = Session::get('company_id');
        $optnList   = '';
        $optionArr = \App\Models\CompanyProject::where('company_id', $company_id)
...
if (!function_exists('all_languages')) {
    ...
    {
        $dataArr = \App\Models\AllLanguage::where('active', 1)->get();
        return $dataArr;
    }
}
/* Used in : */
if (!function_exists('industries')) {
    function industries()
    {
        $dataArr = \App\Models\Industry::where('status', 1)->get();
        return $dataArr;
    }
}

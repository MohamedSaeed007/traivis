...
class UserRegistrationMail extends Mailable
{
    ...
    {
        $emailTemplate = \App\Models\EmailTemplate::where('key', $this->_key)->first();
    ...
    private function _sendPasswordResetMail()
    {
        ...
        if ($emailTemplate) {
            ...
            $template = str_replace('[Name]', $this->_user->name, $template);
            $template = str_replace('[activation_token]',
                ENV('APP_URL') . ('/forgot-password/reset/' . $this->_user->reset_token . '?email=' . $this->_user->email),
                $template);

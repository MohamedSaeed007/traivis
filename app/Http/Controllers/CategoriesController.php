...
class CategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['categories'] = Category::whereStep(0)->with('sub_categories',
            'sub_categories.sub_categories')->orderBy('category_name', 'asc')->paginate(2);
    ...
    public function edit($id)
    {
        ...
        $data['categories'] = Category::whereStep(0)->with('sub_categories')->orderBy('category_name',
            'asc')->where('id', '!=', $id)->get();

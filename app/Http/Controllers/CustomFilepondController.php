...
class CustomFilepondController extends BaseController
{
    /**
     * @var Filepond
     */
    ...
    private function handleChunkInitialization()
    {
        ...
        $fileCreated = Storage::disk($disk)->put($fileLocation, '');
    ...
    public function restoreMedia(Request $request)
    {
        //        $a = Assignment::find(1);
        //        $a->addMedia(
        //            'D:/Dropboxes/Dropbox/Screenshots/SC/2023-05/navicat_2023-05-09 00_04_33_751-XIitkbgbvj.png'
        //        )
        //            ->preservingOriginal()
        //            ->toMediaCollection('resources');

        $media = MediaLibrary::findByUuid($request->get('id'));

...
class BannerController extends Controller
{
    ...
    {
        $data = Banner::orderBy('updated_at', 'asc')->get();
    ...
    {
        $data = HomeBanner::orderBy('updated_at', 'asc')->get();
    ...
    {
        $pages = HomePageSection::where('status', 1)->get();
    ...
    {
        return HomeBanner::select('slug')->where('slug', 'like', $slug.'%')
            ->where('id', '<>', $id)
            ->get();
    }

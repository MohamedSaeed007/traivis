...
use App\Models\LiveScheduleUser;
...
class LiveScheduleController extends Controller
{
    ...
    public function createForm($slug)
    {
        ...
        $coursePurchase = CourseUser::where('course_id', $courseId)->get();
        if ($coursePurchase) {
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view(theme('dashboard.live-schedule.edit'),
            compact('title', 'userName', 'courseId', 'section', 'liveSchedule'));
    }

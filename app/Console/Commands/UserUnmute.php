...
class UserUnmute extends Command
{
     ...
     * @var string
     */
    protected $signature = 'user:unmute {--lecture-id= : The ID of the lecture} {--user-id= : The ID of the user}';
    ...
    public function handle()
    {
        ...
        $lecture->unmuteUser($user);
        $this->info("User {$user->id}- {$user->name}, unmuted by user.");

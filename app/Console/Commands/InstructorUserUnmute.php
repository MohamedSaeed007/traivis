...
class InstructorUserUnmute extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'instructor:user:unmute {--lecture-id= : The ID of the lecture} {--user-id= : The ID of the user}';
    ...
    public function handle()
    {
        ...
        $lecture->unmuteUser($user, true);
        $this->info("User {$user->id}- {$user->name}, unmuted by instructor.");

...
class InstructorUserMute extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'instructor:user:mute {--lecture-id= : The ID of the lecture} {--user-id= : The ID of the user}';
    ...
    public function handle()
    {
        ...
        $lecture->muteUser($user, true);
        $this->info("User {$user->id}- {$user->name}, muted by instructor.");

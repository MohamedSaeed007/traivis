...
class Category extends Model
{
    ...
    public function courses()
    {
        ...
        return $this->belongsToMany(Course::class)->publish()->orderBy('created_at', 'desc');
    }
    ...
    {
        return $this->belongsToMany('App\Models\bidding', 'bidding_category', 'category_id', 'bidding_id');
    }

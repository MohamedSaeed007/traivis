  ...
  <div class="banner-wrapper-content mt150">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="business-banner-image">
                            <img loading="lazy" src="{{theme_asset('website/img/business-coaching/man.png')}}" alt="image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="business-shape2"><img loading="lazy" src="{{theme_asset('website/img/business-coaching/business-shape2.png')}}" alt="image"></div>
        ...
        <section class="courses-area ptb-100">
                        ...
                        <div class="courses-box">
                            <div class="courses-image">
                                <a href="#!" class="d-block image">
                                    <img loading="lazy" src="{{ $course->thumbnail_url }}" alt="image">
                                </a>
            ...
            <div class="business-shape5"><img loading="lazy" src="{{theme_asset('website/img/business-coaching/business-shape4.png')}}" alt="image"></div>
        </section>
                    ...
                    <div class="single-feedback-box">
                        ...
                        <div class="info">
                            <div class="d-flex align-items-center justify-content-center">
                                <img loading="lazy" src="@if($testimonial->img){!! asset('testimonial_images/'.$testimonial->img) !!} @else {{ asset('images/noimage.jpg') }} @endif" alt="image">
                                <div class="title">
                                       @if(App::getLocale()=='ar')
                ...
                <div class="partner-slides owl-carousel owl-theme">
                    <div class="single-partner-item">
                        <a href="#!" class="d-block">
                            <img loading="lazy" src="{{theme_asset('website/img/partner/7.png')}}" alt="image">
                        </a>
                    </div>

                    <div class="single-partner-item">
                        <a href="#!" class="d-block">
                            <img loading="lazy" src="{{theme_asset('website/img/partner/8.png')}}" alt="image">
                        </a>
                    </div>

                    <div class="single-partner-item">
                        <a href="#!" class="d-block">
                            <img loading="lazy" src="{{theme_asset('website/img/partner/9.png')}}" alt="image">
                        </a>
                    </div>

                    <div class="single-partner-item">
                        <a href="#!" class="d-block">
                            <img loading="lazy" src="{{theme_asset('website/img/partner/10.png')}}" alt="image">
                        </a>
                    </div>

                    <div class="single-partner-item">
                        <a href="#!" class="d-block">
                            <img loading="lazy" src="{{theme_asset('website/img/partner/11.png')}}" alt="image">
                        </a>
                    </div>

                    <div class="single-partner-item">
                        <a href="#!" class="d-block">
                            <img loading="lazy" src="{{theme_asset('website/img/partner/12.png')}}" alt="image">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="become-instructor-partner-image bg-image1 jarallax" data-jarallax='{"speed": 0.3}'>
                            <img loading="lazy" src="{{theme_asset('website/img/become-instructor.jpg')}}" alt="image">
                        </div>
                    </div>

                    <div class="col-lg-6 col-md-6">
                        <div class="become-instructor-partner-image bg-image2 jarallax" data-jarallax='{"speed": 0.3}'>
                            <img loading="lazy" src="{{theme_asset('website/img/become-partner.jpg')}}" alt="image">
                        </div>
                    </div>

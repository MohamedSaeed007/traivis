...
@section('content')
    ...
    @endif
        ...
        <div class="business-shape2"><img loading="lazy" src="{{ theme_asset('website/img/business-coaching/business-shape2.png') }}"
                alt="image"></div>
                    ...
                    <div class="single-feedback-box">
                        ...
                        <div class="info">
                            <div class="d-flex align-items-center justify-content-center">
                                <img loading="lazy" src="@if ($testimonial->img) {!! asset('testimonial_images/' . $testimonial->img) !!}

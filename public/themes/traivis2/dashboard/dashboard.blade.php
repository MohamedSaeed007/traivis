...
@section('content')
    @php
        ...
        $enrolledCount = \App\Models\Enroll::whereUserId($user_id)
            ->whereStatus('success')
            ->count();
        ...
        $totalCourse = \App\Models\Course::whereUserId($user_id)->count();
        $team = \App\Models\InstructorTrainer::whereInstructorUserId($user_id)->count();
        $purchasedUser = \App\Models\Enroll::join('courses', 'courses.id', 'enrolls.course_id')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        margin-bottom: 5px;"><i class="fa fa-envelope" aria-hidden="true"></i> {{Auth::user()->email}}
                        </p>
                    </nav>
                    <br>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 mb-3 ">
                    <i class="float-right far fa-question-circle" style="color: grey ; font-size:30px"
                       data-toggle="tooltip"
                       data-placement="bottom" title="You can get idea about the general details"></i>
                </div>
            </div>
            ...
            @foreach ($purchases as $purchase)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{!! route('purchase_view', $purchase->id) !!}" class="btn btn-info"><i
                                    class="la la-eye"></i> </a>
                    </td>
                </tr>
            @endforeach

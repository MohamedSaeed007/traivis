                    ...
                    <div id="dashboard-section-{{ $section->id }}" class="dashboard-course-section bg-white border mb-4">
                        ...
                        <span>{{ __t('section_type') }} : @if ($section->section_type == 1) Face to face @elseif($section->section_type
                            ...
                            <button
                                ...
                                <div class="section-item-btn-tool ml-2">
                                    <i class="float-right far fa-question-circle" style="color: grey ; font-size:25px"
                            data-toggle="tooltip" data-placement="bottom" title="Click on lecture , quiz or assignments tab on the bottom blue nav"></i>
                                </div>

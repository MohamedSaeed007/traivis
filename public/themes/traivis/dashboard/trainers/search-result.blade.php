        ...
        <div class="dashboard-card mb-12 d-flex border p-3 bg-white">
            <div class="card-icon mr-2 mr10">
                @if ($user->profile_pic)
                    ...
                    <img loading="lazy" src="{{ asset('assets/profile_pics/' . $user->profile_pic) }}" width="100" height="100"
                        class="avatar rounded-circle" alt="Avatar image">

                @else
                    <img loading="lazy" src="http://train.ca/themes/traivis/assets/website/img/user.png" width="100" height="100"
                        class="avatar rounded-circle" alt="Avatar image">
                @endif
            </div>

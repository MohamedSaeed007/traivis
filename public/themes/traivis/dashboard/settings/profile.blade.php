...
@section('content')
    ...
    <div class="dashboard-inline-submenu-wrap border-bottom mb-4">
        <div class="pb15" id="acc">
            ...
            <i class="far fa-question-circle float-right" style="color: grey ; font-size:30px"
                data-toggle="tooltip" data-placement="bottom" title="Find Courses"></i>
        </div>
            ...
            <div class="profile-basic-info bg-white p-3">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="choose-img-div">
                            <img loading="lazy" class="profile_pic" name="profile_pic" id="profile_pic" width="150"
                                height="auto"
                                src="@if ($user->profile_pic) {!! asset('assets/profile_pics/' . $user->profile_pic) !!}
                        @else {!! asset('assets/images/placeholder-image.png') !!} @endif">
                            <input type="file" name="profile_file" id="profile_file" class="profile_file"
                                accept="image/*" capture style="display:none">
                            <img loading="lazy" src="{!! asset('assets/images/file_choose.png') !!}" id="upfile1" class="choose-img"
                                style="cursor:pointer" title="Change Profile Picture" />
                        </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <label> &nbsp;&nbsp;Tell us about your experience and education to get a personalized
                            learning
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="prefered_study_language"
                                name="prefered_study_language[]" data-toggle="select2" data-search="true"
                                multiple>
                                @foreach (all_languages() as $language)
                                    <option @if (in_array($language->id, $individualLanguages)) selected="" @endif
                                        value="{{ $language->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="highest_degree" id="highest_degree"
                                ...
                                @foreach ($highest_degrees as $highest_degree)
                                    <option @if ($indUser && $indUser->highest_degree_id == $highest_degree->id) selected @endif
                                        value="{{ $highest_degree->id }}">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="university" id="university" class="form-control"
                                ...
                                value="@if ($indUser && $indUser->university) {{ $indUser->university }} @endif">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select name="major" id="major" class="form-control">
                                ...
                                @if ($major_fields)
                                    @foreach ($major_fields as $major)
                                        <option @if ($indUser && $indUser->major_id == $major->id) selected @endif
                                            value="{{ $major->id }}">
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select name="employment_status" id="employment_status" class="form-control">
                                <option value="">-Select-</option>
                                <option value="1" @if ($currentJob && $currentJob->employment_status == 1) selected @endif>
                                    Currently working</option>
                                <option value="2" @if ($currentJob && $currentJob->employment_status == 2) selected @endif>
                                    Worked in past</option>
                                <option value="3" @if ($currentJob && $currentJob->employment_status == 3) selected @endif>
                                    Unemployed</option>
                                <option value="4" @if ($currentJob && $currentJob->employment_status == 4) selected @endif>
                                    Student</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select id="job_industry" name="job_industry" data-toggle="select2"
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="current_employer" id="current_employer"
                                class="form-control"
                                value="@if ($currentJob) {{ $currentJob->employer }} @endif"
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select id="current_occupation" name="current_occupation"
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <select name="current_experience_level" id="current_experience_level"
                                class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="">
                                        <input type="radio"
                                            @if ($indUser && $indUser->new_job_preference == 1) checked @endif
                                            name="new_job_preference" value="1">
                                ...
                                <div class="col-md-3">
                                    <div class="">
                                        <input type="radio"
                                            @if ($indUser && $indUser->new_job_preference == 0) checked @endif
                                            name="new_job_preference" value="0">
                    ...
                    <div class="col-md-6 mb15 newjob hide">
                        <div class="form-group">
                            ...
                            <select id="preferred_industry" name="preferred_industry[]"
                                data-toggle="select2" data-search="true"
                                class="form-control js-example-basic-single" multiple>
                                @foreach ($industries as $industry)
                                    <option value="{{ $industry->id }}"
                                        @if (in_array($industry->id, $individualIndustries)) selected="" @endif>
                                        {{ $industry->en_name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6 mb15 newjob hide">
                        <div class="form-group">
                            ...
                            <select id="preferred_occupation" name="preferred_occupation[]"
                                data-toggle="select2" data-search="true"
                                class="form-control js-example-basic-multiple" multiple>
                                @foreach ($occupations as $occupation)
                                    <option value="{{ $occupation->id }}"
                                        @if (in_array($occupation->id, $individualOccupation)) selected="" @endif>
                    ...
                    <div class="col-md-6 mb15 newjob hide">
                        <div class="form-group">
                            ...
                            <select name="preferred_exp_level" id="preferred_exp_level"
                                class="form-control">
                                <option value="1">Entry-level</option>
                                <option value="2">Intermediate</option>
                                <option value="3">Mid-level</option>
                    ...
                    <div class="col-md-12 mb15">
                        <div class="form-group">
                            ...
                            <select id="skills_wanted" name="skills_wanted[]" data-toggle="select2"
                                data-search="true" class="form-control js-example-basic-single" multiple>
                                @foreach ($skills as $skill)
                                    <option @if (in_array($skill->id, $individualSkillsWanted)) selected="" @endif
                                        value="{{ $skill->id }}">
                    ...
                    <div class="col-md-12 mb15">
                        <div class="form-group">
                            ...
                            <textarea name="career_goal" id="career_goal" class="form-control" id="" rows="4"
                                placeholder="Tell us what you're looking for next in your career to find new opportunities">
@if ($indUser && $indUser->career_goal)
{{ $indUser->career_goal }}
@endif
</textarea>
                        </div>
                    ...
                    <div class="col-md-6 mb15">
                        <div class="form-group">
                            ...
                            <input type="checkbox" id="goal_privacy" name="goal_privacy"
                                @if ($indUser && $indUser->goal_privacy == 1) checked @endif value="1">
                        </div>
                    </div>
                ...
                <div class="panel panel-light h-auto" id="cpe">
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <label> Introduce yourself to the Traivis community. Connect with learners like
                                you to grow your
                                network.</label>

                            <div class="tab-pane fade show active" id="user-profile-tab-1"
                                aria-expanded="true">
                                <div class="mx-auto">
                                    <div class="row">
                                        <div class="col-md-12 mb15">
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1">Tell us about
                                                    yourself, such as
                                                    what you do, what your interests are, and what you hope
                                                    to get out of
                                                    your courses.</label>
                                                <textarea name="self_intro" id="self_intro" class="form-control" id="" rows="4"
                                                    placeholder="Self introduction">
@if ($indUser && $indUser->self_intro)
{{ $indUser->self_intro }}
@endif
</textarea>
                                            </div>
                                        ...
                                        <div class="col-md-12 mb15">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="living_location">
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option value="{{ $country->id }}"
                                                            @if (isset($indUser->living_location)) {{ selected($indUser->living_location, $country->id) }} @endif>
                                                            {!! $country->name !!}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-12 mb15">
                                            <div class="form-group">
                                                ...
                                                <select id="top_skills" name="top_skills[]"
                                                    data-toggle="select2" data-search="true"
                                                    class="form-control js-example-basic-single" multiple>
                                                    @foreach ($skills as $skill)
                                                        <option
                                                            @if (in_array($skill->id, $individualTopSkills)) selected="" @endif
                                                            value="{{ $skill->id }}">
                                                            {{ $skill->en_skill }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb15">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone_number"
                                                    ...
                                                    value="@if ($indUser && $indUser->phone_number) {{ $indUser->phone_number }} @endif"
                                                    placeholder="(for a verification purpose) ">
                                            </div>
                                        </div>
                                        {{-- insta fb linked in
                 twitter --}}
                                        <div class="col-md-6 mb15">
                                            <div class="form-group">
                                                ...
                                                <select name="gender" id="gender"
                                                    ...
                                                    <option value="">-Select-</option>
                                                    <option
                                                        @if ($indUser && $indUser->gender == 1) selected @endif
                                                        value="1">Female </option>
                                                    <option
                                                        @if ($indUser && $indUser->gender == 2) selected @endif
                                                        value="2">Male </option>
                                                    <option
                                                        @if ($indUser && $indUser->gender == 3) selected @endif
                                                        value="3">I'd rather not say
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb15">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="dob" id="dob"
                                                    class="form-control" placeholder="Month Day Year ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb15">
                                            <div class="form-group">
                                                ...
                                                <label for="">(Only me)</label>
                                                <input type="checkbox" name="personal_privacy"
                                                    id="personal_privacy" value="1">
                                            </div>
                                        </div>

                                        <div class="col-md-12 mb15">
                                            <div class="form-group">
                                                <label for="">Note: Discussion forum posts and peer
                                                    review submissions will
                                                    always show your name and profile image to other learners
                                                    in your
                                                    courses. Course ratings and reviews you submit may show
                                                    your profile
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group text-right">
                                                <input type="hidden" id="user_id" name="user_id"
                                                    value="">
                                                <input type="hidden" id="individual_id"
                                                    name="individual_id" value="">
                                                <input type="hidden" id="current_job_id"
                                                    name="current_job_id" value="">
                                                <input type="hidden" id="preferred_job_id"
                                                    name="preferred_job_id" value="">

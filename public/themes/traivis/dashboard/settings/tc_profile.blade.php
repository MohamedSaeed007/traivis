            ...
            <div class="profile-basic-info bg-white p-3 row">
                ...
                <div class="form-group col-md-3 mb15">
                    ...
                    <div class="choose-img-div">
                        <img loading="lazy" class="profile_pic" name="profile_pic" id="profile_pic" width="150" height="auto"
                        ...
                        <img loading="lazy" src="{!! asset('assets/images/file_choose.png') !!}" id="upfile1" class="choose-img" style="cursor:pointer"

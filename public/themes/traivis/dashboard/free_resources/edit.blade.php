 ...
 <div class="row">
          ...
          <div class="form-group @if($errors->first('name')) has-error @endif">
                ...
                <div class="col-sm-10 choose-img-div">
                                        <img loading="lazy" class="profile_pic" name="profile_pic" id="profile_pic"  width="150" height="auto" src="@if($free_resource->img) {!! asset('uploads/free_resources_images/'.$free_resource->img) !!} @else {!! asset('admin/img/administrator.png') !!} @endif">
                                       <input type="file" name="profile_file" id="profile_file" class="profile_file" accept="image/*" capture style="display:none">
                                       <img loading="lazy" src="{!! asset('admin/images/file_choose.png') !!}" id="upfile1" class="choose-img" style="cursor:pointer" title="Change Profile Picture" />
                                    </div>

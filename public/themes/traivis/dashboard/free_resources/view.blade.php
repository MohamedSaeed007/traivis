         ...
         <div class="col col-avatar py-3 py-md-0">
            <div class="user-avatar-inside-svg">
               <div class="user-avatar">
                  <img loading="lazy" src="@if(isset($basic_data->logo)){!! asset('uploads/company_logos/'.$basic_data->logo) !!} @else {!! asset('images/noimage.jpg') !!} @endif" class="avatar avatar-4 rounded-circle" alt="">
               </div>

                ...
                <div class="flex-1">
                    ...
                    <div class="-mt-9">
                        ...
                        <form action="{{route('forgot-password-post')}}" method="post">
                            @csrf
                            <div>
                                <h1 class="text-3xl font-bold">Find Your Account</h1>
                                <div class="mt-6"></div>
                                <label for="Username" class="block mb-2 text-md text-gray-600">Put in
                                Put in your email and we will send you a link to reset your password. </label>
                                <div class="mt-6"></div>
                                <div class="relative group ">
                                    <input class="{{ $errors->has('email') ? 'border-red-500 focus-within:border-red-500 active:border-red-500' : 'border-gray-300 focus-within:border-blue-500 active:border-blue-500' }} border w-full outline-none  bg-white px-4 py-1 rounded-full focus-within:ring-blue-500 focus-within:ring-1  transition-colors text-l font-bold h-10 px-2  rounded-full mt-1 sm:truncate   transition-colors peer"

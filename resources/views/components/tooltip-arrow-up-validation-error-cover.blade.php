...
<p class="group/v flex items-center gap-x-2 absolute bottom-2 left-0 text-black text-sm font-medium h-fit px-2 bg-white border border-blue-500 rounded-md z-10">
    ...
    <span class="hidden group-hover/v:block">{{$message}}</span>
</p>
    ...
    <li class="mb-20 bg-white p-4 transition-colors  sm:rounded-lg drop-shadow-[0_1px_1px_rgba(0,0,0,0.15)]">
        <article aria-labelledby="question-title-81614">
            ...
            <div>
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="flex h-8 flex-row">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                class="my-auto ml-2 h-5 text-traivis-500" width="24" height="24" viewbox="0 0 24 24"
                                fill="currentColor">
                                <path
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div id="post-dropdown"
                                ...
                                <div class="py-1" role="none">
                                    ...
                                    <a href="#" class="flex px-4 py-2 text-sm text-gray-700" role="menuitem"
                ...
                <!--------- feed content--------->
                <h2 id="question-title-81614" class="py-4 text-lg font-medium text-gray-900   break-words">What
                    would
                    you have done differently if you ran Jurassic Park?</h2>
                <div
                ...
                <div class="flex items-center justify-between justify-items-center p-3 gap-x-8 text-gray-400">
                    ...
                    <span class="inline-flex items-center gap-x-8 text-sm">
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewbox="0 0 24 24" width="512"
                                height="512" fill="currentColor" aria-hidden="true" class="h-5 w-5">
                                <path
                        ...
                        <button type="button"
                            ...
                            </svg><span class="hidden font-medium text-gray-900  ">9</span>
                    ...
                    <span class="inline-flex items-center gap-x-8 text-sm">
                        ...
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                                y="0px" viewbox="0 0 512.19 512.19" xml:space="preserve" width="512" height="512"
                    ...
                    <span class="inline-flex items-center text-sm ml-auto">
                        <button type="button"
                            ...
                            </svg><span class="hidden font-medium text-gray-900  ">Save</span>
                        </button>
                    </span>
                    ...
                    <span class="inline-flex items-center text-sm">
                        <button type="button"
                            ...
                            </svg><span class="hidden font-medium text-gray-900  ">Share</span>
                        </button>
                    </span>
            ...
            <div class="mt-4 flex items-start space-x-4">
                ...
                <div class="min-w-0 flex-1">
                    <form action="#">
                        ...
                        <div class="border-b border-gray-200 focus-within:border-traivis-600">
                            <label for="comment" class="sr-only">Add your comment</label>
                            <textarea rows="3" name="comment" id="comment"
                                class="block w-full resize-none border-0 border-b border-transparent p-0 pb-2 transition-colors focus:border-traivis-600 focus:ring-0  sm:text-sm"
                        ...
                        <div class="flex justify-between pt-2">
                            <div class="flex items-center space-x-5">
                                ...
                                <div class="flow-root">
                                    <div>
                                        <label id="listbox-label" class="sr-only"> Your
                                            mood </label>
                                        <div class="relative">
                                            ...
                                            <button type="button"
                                                ...
                                                <span class="flex items-center justify-center">
                                                    ...
                                                    <span>
                                                        ...
                                                        </svg><span class="sr-only"> Add your mood </span>
                                                    </span>
                                                </span>
                                            </button>
                            ...
                            <div class="flex-shrink-0">
                                <button type="submit"
                                    class="inline-flex items-center rounded-full border border-transparent bg-traivis-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-traivis-700 focus:outline-none focus:ring-2 focus:ring-traivis-500 focus:ring-offset-2">
                                    Comment
                                </button>
                            </div>

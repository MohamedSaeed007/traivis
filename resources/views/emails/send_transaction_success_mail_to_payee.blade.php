                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="text center"
                                                                ...
                                                                Hi <strong>
                                                                    {{ $transaction->payeeable->business_email }}
                                                                </strong>, Congratulation your course has been purchased
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" bgcolor="#333333"
                                                                                class="text-btn">
                                                                                @if ($transaction->payeeable->business_type == 'instructor')
                                                                                <a
                                                                                    href="{{ route('transaction-invoice',$transaction) }}"
                                                                                ...
                                                                                @endif
                                                                                @if ($transaction->payeeable->business_type == 'institute')
                                                                                <a
                                                                                    href="{{ route('transaction-invoice',$transaction) }}"
                                                                                    style="color: #ffffff; font-family:Helvetica,Arial,sans-serif; font-size: 12px; line-height: 14px; text-align: center; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; border: 1px solid #333333; display: inline-block; mso-line-height-rule: exactly; padding: 15px 40px;"
                                                                                    target="_blank">

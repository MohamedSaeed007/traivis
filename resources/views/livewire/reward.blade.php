<div>
    ...
    @foreach ($user->rewards as $reward)
        ...
        <div
            ...
            <div
                    class="group:text-gray-500 flex w-1/2 justify-start px-4 py-2 transition-colors md:w-1/4 md:justify-center md:py-0">
                ...
                <div class="flex">
                    <p class="texy-base flex items-center justify-center truncate font-medium text-gray-400 transition-colors group-hover:text-gray-700 "
                       contenteditable="false">{{$reward->reward_name}}</p>
                </div>
            </div>
            ...
            <div
                ...
                <a href="#" class="flex justify-center">
                    ...
                    <div contenteditable="false" class="flex">
                        <p class="texy-base flex items-center truncate font-medium text-gray-400 transition-colors group-hover:text-gray-700 "
                           contenteditable="false">{{$reward->reward_provider}}</p>
                    </div>
                </a>
            </div>
            ...
            <div
                    class="flex w-1/2 justify-start px-4 py-2 md:w-1/4 md:justify-center md:py-0">
                <a class="texy-base mr-2 mb-1 inline-block flex items-center justify-center py-1 px-2 text-gray-400 group-hover:text-gray-700  lg:mb-0"
                   href="#">
                    ...
                    <h3 class="rounded-full border border-gray-400 px-2 text-base font-medium group-hover:border-gray-700
                        ">
                        {{$reward->reward_date}}</h3>
                </a>
            </div>

            <div
                    class="flex w-1/2 justify-start px-4 py-2 md:w-1/2 md:justify-center md:py-0">
                <a class="texy-base mr-2 mb-1 inline-block flex items-center justify-center py-1 px-2 text-gray-400 group-hover:text-gray-700  lg:mb-0"
                   href="#">
                    ...
                    <h3
                            class="truncate rounded-full border border-gray-400 px-2 text-base font-medium
                            transition-colors group-hover:border-gray-700 ">
                        {{$reward->reward_related_links}}
                    </h3>
...
{{--                    </svg>--}}
    ...
    @endforeach
    @else
    <p>The user make this page private</p>
    @endif
</div>

<div>
    <div class="pt-2">
        ...
        <a href="#"
            ...
            <x-svg-icons.fi-rr-hastag />

            <span class="truncate font-bold text-gray-500">Trending Courses</span>
                        ...
                        <li
                            ...
                            <div class="flex flex-1 items-center justify-between truncate">
                                ...
                                {{-- <div class="flex-shrink-0 pr-2">
                                    <button type="button"
                                        class="inline-flex h-8 items-center justify-center rounded-full bg-white bg-transparent text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-traivis-500 focus:ring-offset-2">

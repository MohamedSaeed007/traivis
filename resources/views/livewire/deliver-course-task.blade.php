<div class="w-full">
    ...
    <!-- popup content-->
    <div
        class="relative my-8 inline-block w-full transform rounded-lg bg-white p-4 text-left align-middle transition-all">
        ...
        <div class="flex items-center justify-center">
            <p
                ...
                <svg fill="currentColor" class="mr-3 h-10 w-10 text-green-600" viewBox="0 0 24 24"

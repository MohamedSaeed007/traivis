...
@section('content')
    <div class="bg-white ">
        <div class="flex justify-center">
            ...
            <!--/Left Side-->
            <!--Register Form-->
            <div class="flex-col justify-center h-auto items-center overflow-y-auto px-12  w-full pb-5 lg:px-6 mx-auto  lg:w-1/3 text-gray-500">
                <!--Pic-->
                ...
                <form method="POST" action="{{ secure_url(route('register')) }}">
                    ...
                    <div class="relative group">
                        <input class="{{ $errors->has('name') ? 'border-red-500 focus-within:border-red-500 active:border-red-500' : 'border-gray-300 focus-within:border-traivis-500 active:border-traivis-500' }} w-full outline-none border bg-white py-1 focus-within:ring-traivis-500 focus-within:ring-1 transition-colors text-l font-bold h-10 px-2  rounded-full mt-1 sm:truncate peer"
                               id="Hero" required="" type="text" name="name" value="{{ old('name') }}">
                    ...
                    <div class="relative group mt-5 ">
                        <input class="{{ $errors->has('email') ? 'border-red-500 focus-within:border-red-500 active:border-red-500' : 'border-gray-300 focus-within:border-traivis-500 active:border-traivis-500' }} w-full outline-none border bg-white py-1 focus-within:ring-traivis-500 focus-within:ring-1 transition-colors text-l font-bold h-10 px-2  rounded-full mt-1 sm:truncate peer"
                               id="email" required="" type="text" name="email" value="{{ old('email') }}">
                        <label class="transform transition-all absolute top-5 h-2 left-2 px-2 bg-white flex items-center text-l font-bold
                              group-focus-within:font-medium peer-valid:font-medium  group-focus-within:text-xs peer-valid:text-xs group-focus-within:top-2 peer-valid:top-2 group-focus-within:-translate-y-full peer-valid:-translate-y-full  peer-disabled:top-2 peer-disabled:-translate-y-full peer-disabled:text-xs peer-disabled:font-medium"
                               for="email">
                            Email Address</label>
                    ...
                    <div class="relative group mt-5 ">
                        <input class="{{ $errors->has('birth_date') ? 'border-red-500 focus-within:border-red-500 active:border-red-500' : 'border-gray-300 focus-within:border-traivis-500 active:border-traivis-500' }} w-full outline-none border bg-white py-1 focus-within:ring-traivis-500 focus-within:ring-1 transition-colors text-l font-bold h-10 px-2  rounded-full mt-1 sm:truncate peer"
                               id="Birth" required="" type="date" name="birth_date" value="{{ old('birth_date') }}">
                        <label class="transform transition-all absolute top-4 h-2 left-2 px-2 pr-7  py-3 bg-white flex items-center text-l font-bold
                              group-focus-within:font-medium peer-valid:font-medium  group-focus-within:text-xs group-focus-within:pr-2 peer-valid:text-xs peer-valid:pr-2  group-focus-within:top-4 peer-valid:top-4 group-focus-within:-translate-y-full peer-valid:-translate-y-full  peer-disabled:top-2 peer-disabled:-translate-y-full peer-disabled:text-xs peer-disabled:font-medium"
                               for="Birth">
                            Birth Date</label>
                    ...
                    <div class="relative group mt-5 ">
                        <input class="{{ $errors->has('password') ? 'border-red-500 focus-within:border-red-500 active:border-red-500' : 'border-gray-300 focus-within:border-traivis-500 active:border-traivis-500' }} w-full outline-none border bg-white py-1 focus-within:ring-traivis-500 focus-within:ring-1 transition-colors text-l font-bold h-10 px-2  rounded-full mt-1 sm:truncate peer"
                    ...
                    <div class="relative group mt-5 ">
                        <input class="{{ $errors->has('password_confirmation') ? 'border-red-500 focus-within:border-red-500 active:border-red-500' : 'border-gray-300 focus-within:border-traivis-500 active:border-traivis-500' }} w-full outline-none border bg-white py-1 focus-within:ring-traivis-500 focus-within:ring-1 transition-colors text-l font-bold h-10 px-2  rounded-full mt-1 sm:truncate peer"
                               id="confirm-Password" required="" type="password" name="password_confirmation">
                        <label class="transform transition-all absolute top-5 h-2 left-2 px-2 bg-white flex items-center text-l font-bold
                              group-focus-within:font-medium peer-valid:font-medium  group-focus-within:text-xs peer-valid:text-xs group-focus-within:top-2 peer-valid:top-2 group-focus-within:-translate-y-full peer-valid:-translate-y-full  peer-disabled:top-2 peer-disabled:-translate-y-full peer-disabled:text-xs peer-disabled:font-medium"
                    ...
                    <div class="mt-6" x-data="{show:false}">
                        ...
                        <section x-show="show"
                            ...
                            <div x-show="show" @click.outside="open = false"
                                 class="md:max-w-4xl w-full m-auto bg-white rounded-md p-3">
                                <!-- Modal content -->
                                <div @click.away="show = false" x-transition:leave="transition ease-in duration-150"
                                                    ...
                                                    <form action="" method="post">
                                                        <div class="flex flex-col space-y-16">
                                                            <div class="flex flex-row items-center justify-between mx-auto w-full max-w-xs">
                                                                <div class="w-16 h-16 ">
                                                                    <input class="w-full h-full flex flex-col items-center justify-center text-center px-5 outline-none rounded-xl border border-gray-200 text-lg bg-white focus:bg-gray-50 focus:ring-1 ring-traivis-500"
                                                                           type="text" name="" id="">
                                                                </div>
                                                                <div class="w-16 h-16 ">
                                                                    <input class="w-full h-full flex flex-col items-center justify-center text-center px-5 outline-none rounded-xl border border-gray-200 text-lg bg-white focus:bg-gray-50 focus:ring-1 ring-traivis-500"
                                                            ...
                                                            <div class="flex flex-col items-center space-y-5">
                                                                <div>
                                                                    <button class="  transition inline-flex flex justify-center items-center px-3.5 py-2 border border-transparent text-sm leading-4 font-medium rounded-full shadow-sm space-x-2 text-white bg-traivis-500 hover:bg-traivis-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-traivis-500">
                                                                        <a href="./seconedStep.html">Verify Account</a>
                                                                    </button>
                                                                </div>
                        ...
                        <div>
                            <div class="mt-6">
                                <button type="submit" @click="show =!show"
                                        class=" w-full transition inline-flex justify-center items-center px-3.5 py-2 border border-transparent text-sm leading-4 font-medium rounded-full shadow-sm space-x-2 text-white bg-traivis-500 hover:bg-traivis-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-traivis-500">
                                    Submit
                                </button>
                            </div>
                        </div>
                    ...
                    {{--                    </div>--}}
                    <p class="mt-6 text-sm text-center text-gray-400">Do you have an account? <a
                                href="{{ URL::to('/login') }}"
                                class="text-traivis-500 focus:outline-none focus:underline hover:underline">Login</a>
                    </p>
                </form>
                <!--/Form-->
            </div>

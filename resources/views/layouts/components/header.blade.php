                ...
                <div class="raque-nav">
                    <div class="container-fluid">
                        <nav class="navbar navbar-expand-md navbar-light">
                            ...
                            <div class="navbar-collapse mean-menu collapse">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a href="#!"
                                            class="nav-link">{{ __t('label_training_organization') }}
                                            &nbsp;
                                            <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a
                                                    href="{{ URL::to('/training-centre-landing') }}"
                                                    data-role="4"
                                                    class="nav-link">{{ __t('label_register_as_training_center') }}</a>
                                            </li>
                                            <li class="nav-item"><a
                                                    href="{{ URL::to('/trainer-landing') }}"
                                                    data-role="5"
                                                    class="nav-link">{{ __t('label_register_as_trainer') }}</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-item"><a
                                            href="{{ URL::to('/individual-user-landing') }}"
                                    ...
                                    @if (!Auth::check())
                                        <li class="nav-item"><a href="{{ URL::to('/login') }}"
                                                class="nav-link"
                                                id="loginBtn">{{ __t('label_login') }}</a>
                                        </li>

                                        <li class="nav-item"><a href="#!"
                                                class="nav-link">{{ __t('sign-up') }}</a>
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a
                                                        href="{{ URL::to('/register/company') }}"
                                                        class="nav-link"
                                                        id="myBtn2">{{ __t('title_register_as_company') }}</a>
                                                </li>

                                                <li class="nav-item"><a
                                                        href="{{ URL::to('/register/instructor') }}"
                                                        class="nav-link"
                                                        id="myBtn3">{{ __t('title_register_training_centers') }}</a>
                                                </li>

                                                <li class="nav-item"><a
                                                        href="{{ URL::to('/register/trainer') }}"
                                                        class="nav-link"
                                                        id="myBtn4">{{ __t('label_register_as_trainer') }}</a>
                                                </li>

                                                <li class="nav-item"><a
                                                        href="{{ URL::to('/register/student') }}"
                                                        class="nav-link"
                                                        id="myBtn5">{{ __t('label_register_as_individual') }}</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="nav-item mt-4 pl-4 pt-1">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input"
                                                    id="darkSwitch" />
                                                <label class="custom-control-label"
                                                    for="darkSwitch"></label>
                                            </div>
                                    ...
                                    @if (Auth::check())
                                        <li class="nav-item visible-xs"><a href="#!"
                                                class="nav-link"> <img
                                                    src="{{ theme_asset('website/img/user.png') }}"
                                                    class="" alt="image" width="30"
                                                    height="30"></a>
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a
                                                        href="{{ Session::get('redirect_url') }}"
                                                        class="nav-link" id="myBtn2">Dashboard</a>
                                                </li>

                                                <li class="nav-item"><a
                                                        href="{{ URL::to('/logout') }}"
                                                        class="nav-link"
                                                        id="myBtn3">{{ __t('logout') }}</a>
                                                </li>
                                        ...
                                        <select class="change-language"
                                            ...
                                            @foreach (\App\Models\Language::where('active', 1)->get() as $language)
                                                <option style="background:#000;"
                                                    value="{!! $language->code !!}"
                                                    {!! \App::getLocale() == $language->code ? 'selected' : '' !!}>{!! $language->display_name !!}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        @if (Auth::check())
                                            ...
                                            <li class="nav-item"><a href="#!" class="nav-link">
                                                    <img src="{{ theme_asset('website/img/user.png') }}"
                                                        class="mtm20" alt="image" width="30"
                                                        height="30"></a>
                                                <ul class="dropdown-menu">
                                                    <li class="nav-item"><a
                                                            href="{{ Session::get('redirect_url') }}"
                                                            class="nav-link"
                                                            id="myBtn2">Dashboard</a></li>

                                                    <li class="nav-item"><a
                                                            href="{{ URL::to('/logout') }}"
                                                            class="nav-link" id="myBtn3">Logout</a>
                                                    </li>
                ...
                success: function(data) {
                    ...
                    if (data.show_popup) {
                        $('div#success-popup').bPopup({
                            ...
                            onOpen: function() {
                                $("#success-popup").find('span.success')
                                    .html(data
                                        .message);
                            },
                            onClose: function() {

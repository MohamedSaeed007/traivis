...
@section('content')
    ...
    <input type="hidden" name="existRate" id="existRate"
        value="@if ($rating) {{ $rating->rating }} @else 2.5 @endif">
    ...
    <section class="courses-details-area ptb-1100">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        ...
                        <div class="page-title-content">
                            <ul>
                                ...
                                <li class="tblack"><i class="fa fa-angle-double-right"
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    @foreach ($course->getLanguages()->get() as $key => $cl)
                                        <a
                                            href="#!">{{ getAllLanguage($cl->language_id)->en_language }}</a>
                                        @if (!$loop->last)
                                            ,
                                        @endif
                                    @endforeach
                        ...
                        <div class="courses-price">
                            <div class="courses-review">
                                ...
                                <span class="reviews-total d-inline-block">
                                    @if (avgRatings($course->id, 'course'))
                                        ( {{ totalRatings($course->id, 'course')->count() }} ratings)
                                    @else
                                        0 ratings
                                    @endif
                                </span>
                            ...
                            @if (Auth::check() && getRating(Auth::user()->id, $course->id) == false)
                                <a data-toggle="modal" data-target="#myModal" style="cursor: pointer">Write a
                                    review</a>
                            @endif
                            <br>
                            @if (Illuminate\Support\Facades\Auth::check())
                                <div data-id="{{ $course->id }}" class="addtowishlist"
                                    onclick="wishlist({{ $course->id }})">
                                    <a href="javascript:void(0);" class="at-like wibg">
                                        <div id="wish_{{ $course->id }}">
                                            @if (checkWishlist($course->id))
                    ...
                    @else
                        ...
                        @if (Auth::check() && checkPurchase(Auth::user()->id, $course->id))
                            Purchased
                        @elseif(Auth::check())
                            <a href="{{ URL::to('/checkout/' . $course->id) }}" class="default-btn"><i
                                    class='bx bx-paper-plane icon-arrow before'></i><span class="label">Buy
                                    Course</span><i class="bx bx-paper-plane icon-arrow after"></i></a>
                        @else
                            <a href="#!" class="default-btn" id="buyCourse"><i
                                    class='bx bx-paper-plane icon-arrow before'></i><span class="label">Buy
                                    Course</span><i class="bx bx-paper-plane icon-arrow after"></i></a>
                        @endif
                    </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="courses-details-image text-center">
                    <img src="@if ($course->image) {!! asset('uploads/course_images/' . $course->image) !!} @else {!! asset('images/noimage.jpg') !!} @endif"
                        alt="image">
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-12">
                                                <div class="section-title text-left">
                                                    <a href="#!" class="d-block"
                                                        ...
                                                        <img src="@if ($course->user_id && getInstitute($course->user_id)) {!! asset('uploads/provider_images/' . getInstitute($course->user_id)->logo) !!} @else {!! asset('images/noimage.png') !!} @endif"
                                                            alt="image">
                                                    </a>
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="story-content">
                                                    <h3>
                                                        @if ($course->user_id && getInstitute($course->user_id))
                                                            {!! getInstitute($course->user_id)->institute_name !!}
                                                        @endif
                                                    </h3>
                                                    <p>
                                                        @if ($course->user_id && getInstitute($course->user_id))
                                                            {!! getInstitute($course->user_id)->about_institute !!}
                                                        @endif
                                                    </p>
                    ...
                    <div class="feedback-slides-content">
                        ...
                        <div class="feedback-slides-two owl-carousel owl-theme">
                                        ...
                                        <div class="author-profile-title">
                                            ...
                                            <div
                                                ...
                                                <div class="author-profile-raque-profile">
                                                    <a href="#!" class="d-inline-block">View
                                                        Profile</a>
                                                </div>
                                            </div>
                                        </div>
                                        <p>James Anderson is a celebrated photographer, author, and teacher
                                            who brings passion to everything he does.</p>
                            ...
                            <!--    <div class="single-feedback-slides-item">
                                        ...
                                        <div class="author-profile">
                                            <div class="author-profile-title">
                                                <img src="assets/img/user2.jpg" class="rounded-circle shadow-sm" alt="image">
                        ...
                        <div class="courses-review-comments">
                            ...
                            @foreach (totalRatings($course->id, 'course') as $rating)
                                <div class="user-review">
                                    <img src="@if ($rating->getUser && $rating->getUser->avatar) {!! $rating->getUser->avatar !!} @else {!! asset('images/noimage.jpg') !!} @endif"
                                        alt="image">
                                    ...
                                    <div class="review-rating">
                                        ...
                                        <span class="d-inline-block">
                                            @if ($rating->getUser)
                                                {{ $rating->getUser->firstname }} @if ($rating->getUser->lastname)
                                                    {{ $rating->getUser->lastname }}
                                                @endif
                                            @endif
                                        </span>
                                    </div>
                                ...
                                <div class="single-courses-box without-box-shadow mb-30">
                                    <div class="courses-image">
                                        <a href="#!" class="d-block"><img
                                                src="@if ($relatedCourse->image) {!! asset('uploads/course_images/' . $relatedCourse->image) !!} @else {!! asset('images/noimage.jpg') !!} @endif"
                                                alt="image"></a>
                                    ...
                                    <div class="courses-content">
                                        ...
                                        <h3><a href="#!"
                                                class="d-inline-block rcs">{{ $relatedCourse->title_en }}</a>
                                        </h3>
                                        ...
                                        <div class="courses-rating">
                                            ...
                                            <div class="rateYo relatedRate"
                                                id="relatedRate{{ $key }}"></div>

                                            <div class="rating-total">
                                                (@if (totalRatings($relatedCourse->id, 'course'))
                                                    {{ totalRatings($relatedCourse->id, 'course')->count() }}
                                                    ratings
                                                @else
                                                    0 ratings
                                                @endif)
                                        ...
                                        <p class="cp">Education encompasses both the teaching and
                        ...
                        <section class="widget widget_raque_posts_thumb">
                            ...
                            @foreach ($previews as $preview)
                                <article class="item prlt">
                                    ...
                                    <div class="info">
                                        <a href="https://vimeo.com/467141591"
                                            class="attrachment-video popup-youtube vmod"
                                            data-toggle="tooltip" data-placement="top" title=""
                                            data-original-title=""><i
                                                class="bx bx-play-circle fs30"></i></a>
                                        <time datetime="2019-06-30">3 Hours</time>
                                        <h5 class="title usmall"><a
                                                href="#!">{!! $preview->title_en !!}</a></h5>
                                    </div>
        ...
        <input type="hidden" name="get_rate" id="get_rate"
            value="@if (avgRatings($course->id, 'course')) {{ avgRatings($course->id, 'course') }} @else 0 @endif">

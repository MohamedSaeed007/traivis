...
<div class="flex w-full flex-col px-4 ">
    ...
    <div class="sm:flex sm:items-center print:hidden">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">#{{$order->id}}</p>
        </div>
    </div>
    <!--END header-->
                ...
                <div class="text-black font-medium">
                    ...
                    <div class="flex flex-row w-full justify-between items-center pt-4 my-3">
                        <div class=" flex flex-col gap-y-2 ">
                            ...
                            @if ($order->orderable->company_name)
                            <p class="">
                                <span class="text-gray-500 font-bold mr-2"> Company </span>
                                {{ $order->orderable->company_name }}
                            </p>
                            @endif
                            @if ($order->orderable->address)
                            <p class="">
                                ...
                                <tr class="h-10 border-b-2 text-left">
                                    <td class="w-1/2 py-2">
                                        <p class="flex items-start gap-x-4">
                                            ...
                                            @if ($transaction->productable_type == 'App\Models\Plan')
                                            <span> {{$transaction->productable->name}} </span>
                                            @else
                                            <span> {{substr($transaction->productable->title,0,15)}} </span>
                                            @endif
                                        </p>
                                    </td>
                                    <td class="w-1/2 py-2">
                    ...
                    <div class="w-1/2 flex flex-row w-full ml-auto items-center py-6">
                        ...
                        <div class="w-1/3 flex flex-col gap-y-2 whitespace-nowrap truncate">
                            ...
                            {{-- <p class="">
                                {{$order->final_amount - $order->hold_balance}}
                            </p>
                            <p class="text-gray-500 font-bold text-lg mt-4">
                                $ {{$order->hold_balance}}
                            </p> --}}

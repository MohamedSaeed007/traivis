                                ...
                                <li class="accordion-item">
                                    ...
                                    <div class="accordion-content">
                                        <div class="form-check mb10">
                                            <input type="checkbox" class="form-check-input"
                                                id="create-an-account">
                                            <label class="form-check-label" for="create-an-account"> 0-2
                                                Hours (220)</label>
                                        </div>
                                        ...
                                        <div class="form-check mb10">
                                            <input type="checkbox" class="form-check-input"
                                                id="create-an-account">
                                            <label class="form-check-label" for="create-an-account"> 3-6
                                                Hours (140)</label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="create-an-account">
                                            <label class="form-check-label" for="create-an-account"> 6+ Hours
                                                (300)</label>
                                        </div>
                                ...
                                <li class="accordion-item">
                                    ...
                                    <div class="accordion-content">
                                        <label class="mb0">
                                            ...
                                            <div class="review-stars-rated filterr">
                                ...
                                <li class="accordion-item">
                                    ...
                                    <div class="accordion-content">
                                        <div class="form-check mb10">
                                            <input type="checkbox" class="form-check-input"
                                                id="create-an-account">
                                            <label class="form-check-label" for="create-an-account"> Skills
                                                1</label>
                                        </div>
                                ...
                                <li class="accordion-item">
                                    ...
                                    <div class="accordion-content">
                                        <div class="form-check mb10">
                                            <input type="checkbox" class="form-check-input"
                                                id="create-an-account">
                                            <label class="form-check-label" for="create-an-account"> Face
                                                to Face</label>
                                        </div>
                                        ...
                                        <div class="form-check mb10">
                                            <input type="checkbox" class="form-check-input"
                                                id="create-an-account">
                                            <label class="form-check-label" for="create-an-account"> Pre
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="create-an-account">
                                            <label class="form-check-label" for="create-an-account"> Online
                                                Conferencing Call</label>
                                        </div>
                                ...
                                <div class="box-item">
                                    ...
                                    <div class="courses-desc">
                                        <div class="courses-content">
                                            ...
                                            <h3><a href="#!" class="d-inline-block">Professional IT
                                        ...
                                        <div class="courses-box-footer">
                                            <ul>
                                                ...
                                                <li class="courses-lesson">
                                                    <i class='bx bx-book-open'></i> 150 Lectures - All
                                                    levels
                                                </li>
                                ...
                                <div class="box-item">
                                    ...
                                    <div class="courses-desc">
                                        <div class="courses-content">
                                            ...
                                            <h3><a href="#!" class="d-inline-block">Supervisor Safety
                                                    Awareness</a></h3>
                                ...
                                <div class="box-item">
                                    ...
                                    <div class="courses-desc">
                                        <div class="courses-content">
                                            ...
                                            <h3><a href="#!" class="d-inline-block">Fall Protection
                                                    Certificates</a></h3>
                                ...
                                <div class="box-item">
                                    ...
                                    <div class="courses-desc">
                                        <div class="courses-content">
                                            ...
                                            <h3><a href="#!" class="d-inline-block">Diploma in Fire
                                                    and Safety</a></h3>
                        ...
                        <section class="login-area">
                            <div class="row m-0">
                                ...
                                <div class="col-lg-12 col-md-12 p-0">
                                    ...
                                    <div id="particles-js-circle-bubble-3"><canvas
                                            class="particles-js-canvas-el" width="1898" height="820"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group txl">
                                                                    <label><i class="fa fa-user-circle-o"

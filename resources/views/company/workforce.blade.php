            ...
            <div class="row">
                <div class="col-md-12 mb-3 ">
                    <i class="float-right far fa-question-circle" style="color: grey ; font-size:30px" data-toggle="tooltip"
                        data-placement="bottom" title="Add , Edit and Delete Workforces"></i>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group text-right mr20">
                        <a class="btn btn-primary" href="{{ url('company/request-individual-user') }}"><i
                                aria-hidden="true"></i> Request Individual User</a>
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" id="lname" name="lname" class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="department" name="department[]" data-toggle="select2" data-search="true"
                                    class="form-control form-control-lg">
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label for="">Position</label>
                                <select id="position" name="position[]" data-toggle="select2" data-search="true"
                                    class="form-control form-control-lg">
                                </select>
                            </div>
                            <div class="col-md-6 mt20">
                                <label for="">Project</label>
                                <select id="project" name="project[]" data-toggle="select2" data-search="true"
                                    class="form-control form-control-lg">
                                </select>
                            </div>
                        </div>

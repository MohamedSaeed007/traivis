         ...
         <div class="row mt20">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <select id="course_department" name="course_department"  data-search="true" class="form-control">
                  </select>
               </div>
            </div>
            <div class="col-md-5">
                  ...
                  <select id="skills" name="skills[]" data-toggle="select2" data-search="true" class="form-control" multiple>
                     @if ($skill)
                        @foreach ($skill as $skills)
                           <option value="{{$skills->id}}">{{$skills->en_skill}}</option>
                        @endforeach
            ...
            <div class="col-md-3">
               <div class="form-group">
                  ...
                  <select id="occupation" name="occupation[]" data-toggle="select2" data-search="true" class="form-control" multiple>
                     @if ($occupation)
                     @foreach ($occupation as $occupationList)
                        <option value="{{$occupationList->id}}">{{$occupationList->en_occupation}}</option>
                     @endforeach
                        @endif
                  </select>
               </div>
               ...
               <div class="form-group">
                  ...
                  <select id="industry" name="industry[]" data-toggle="select2" data-search="true" class="form-control" multiple>
                     ...
                     @foreach ($industry as $industryList)
                        <option value="{{$industryList->id}}">{{$industryList->en_name}}</option>
                     @endforeach
                        @endif
                  </select>
               </div>

<div class="tab-pane fade" id="panel-with-pills-tab-04" aria-expanded="true">
    ...
    <a href="javascript:window.print()" class=" "><i
        title="download" class="btn-btn-primary">Print</i></a>
...
chart.dataSource.url = 'https://traivis.com/company/'+'get-graph-04-data';
...
chart.dataSource.url = 'https://traivis.com/company/'+'get-graph-04-data-2';
chart.dataSource.load();
chart.dataSource.events.on("done", function(ev) {
    // Data loaded and parsed
    console.log(ev.target.data,'HAI');
...
chart.dataSource.url = 'https://traivis.com/company/'+'get-graph-04-data-3';
chart.dataSource.load();
chart.dataSource.events.on("done", function(ev) {
    // Data loaded and parsed
    console.log(ev.target.data,'HAI');

    ...
    @if (Auth::user()->profile_completion_status == 1 && Auth::user()->verification_status == 0)
        <div class="page-content">
            ...
            <header>
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="mb-0">Your account has been successfully submitted for verification process
                        </h1>
        ...
        <div class="page-content ">
            <div class="row pb-4">
                ...
                <div class="mr-3 ml-auto">
                    <i class=" far fa-question-circle" style="color: grey ; font-size:30px" data-toggle="tooltip"
                       data-placement="bottom" title="You can see here your charts and recently notifications"></i>
                </div>
            </div>
            ...
            <header>
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <a href="{{ URL('company/download-graphs/') }}" target="_blank">Click To Print</a>
                    </div>
                </div>

            </header>

            <div class="page-content bg-secondary mt-3">
                <div class="row mt-n24">
                    ...
                    <div class="col-6 col-sm-4 col-lg-3 col-md-3 mt-24">
                        <div class="widget widget-sm h-full">
                            ...
                            @php
                                ...
                                $countWorkForce = \App\Models\CompanyWorkforce::join('users', 'users.id', 'company_workforce.user_id')
                    ...
                    <div class="col-6 col-sm-4 col-lg-3 col-md-3 mt-24">
                        <div class="widget widget-sm h-full">
                            ...
                            @php
                                $countExternalCourse = \App\Models\CompanyRequiredCourse::where([['type', 2], ['company_id', $company_id]])->count();
                                $countInternalCourse = \App\Models\CompanyRequiredCourse::where([['type', 1], ['company_id', $company_id]])->count();
                    ...
                    <div class="col-6 col-sm-4 col-lg-3 col-md-3 mt-24">
                        <div class="widget widget-sm h-full">
                            ...
                            @php
                                $coursePurchese = \App\Models\CoursePurchase::leftjoin('company_required_courses', 'company_required_courses.id', 'course_purchases.course_id')
                ...
                <div class="row mt-1">
                    <div class="col-md-6">
                        <div class="card-hover-shadow profile-responsive card-border border-success p-3 mt-3 card">
                            <div class="">
                                <p class="text-center font-weight-bold">Percentage Of Expired Certificates For Each
                                    Department</p>
                                {!! $graph2->render() !!}
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="card-hover-shadow profile-responsive card-border border-success p-3  card">
                            <div class="">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-light">
                            <div class="panel-header">
                                ...
                                @php
                                    $notification = \App\Models\UserNotification::where([['notifiable_user_id', Auth::user()->id, ['is_read', 0]]])
                                        ->limit(10)
                                        ->latest()
                                        ->get();
                                @endphp
                                    ...
                                    @if ($notification)
                                        @foreach ($notification as $notifi)
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="timestamp">{{ $notifi->created_at->format('h:i') }}
                                                </div>
                                            </li>
                                        @endforeach
                                    @endif

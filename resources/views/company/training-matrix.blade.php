            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3 ">
                    <i class="float-right far fa-question-circle" style="color: grey ; font-size:30px" data-toggle="tooltip"
                        data-placement="bottom" title="Find details of workers, their department, their positions, their projects and expiry date of each training. Companies can add certificates to their employees. There will be an expiry date for every certificate and the platform will send the notification via email to the company."></i>
                </div>
            </div>
        </header>
            ...
            <div class="modal-content modal-md">
                <form method="POST" enctype="multipart/form-data" id="EditForm">
                                ...
                                <div class="form-group uploadCls certificate-upload">
                                    <div class="custom-file custom-image custom-image-avatar">
                                        ...
                                        <input type="file" name="certificate" id="certificate" data-placeholder=""
                                            class="custom-image-input certificates" id="customImage">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" name="course-department" id="course-department" value="">
                        <input type="hidden" name="course-position" id="course-position" value="">
                        <input type="hidden" name="course-project" id="course-project" value="">
                      
                        
                        {{-- <button type="button" class="btn btn-light" data-dismiss="modal">No</button> --}}
                        <button type="submit" class="btn btn-success btn-hide">Save</button>
                    </div>
                </form>
            </div>
        </div>
...
// });
     function showEditModal(thisObj){
      ...
      $("#course-department").val($(thisObj).attr('data-course-department'));
      $("#course-project").val($(thisObj).attr('data-course-project'));
      $("#course-position").val($(thisObj).attr('data-course-position'));
   ...
   $(function () {
     ...
     $('#edit-modal').on('show.bs.modal', function () {
         ...
         $("#EditForm").validate({
            ...
            //    $2y$10$/lLr0Ey/aJaVkmHrSwxtJuWFh0ecggUpC9Qb4msoEoJiSRxIuD9s2
             },
             messages: {
               issue_date: {

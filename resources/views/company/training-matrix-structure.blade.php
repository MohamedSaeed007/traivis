      ...
      <div class="row">
         <div class="col-md-12 mb-3 ">
            <i class="float-right far fa-question-circle" style="color: grey ; font-size:30px" data-toggle="tooltip"
                data-placement="bottom" title="Add new courses and choose specific Project , postiton and department for each course"></i>
        </div>
         <div class="col-md-6">
       ...
       $.ajax({
               ...
               success: function(data){
                  if(data.status == 'false')
                         {
                         toastr.error(data.message, 'Error', toastr_options);

                         }
                         else
                         {
                           toastr.success('You have successfully deleted', 'Success', toastr_options);

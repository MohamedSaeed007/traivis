<nav id="sidebar" class="sidebar">
    <div class="sidebar-user">
        @if (Auth::user()->user_type != 'admin')
            @if (Auth::user()->avatar != null)
                <img src="{!! Auth::user()->avatar !!}" class="avatar rounded-circle" alt="Avatar image">
            @else
                <img src="{{ asset('users/assets/avatars/1.jpg') }}" class="avatar rounded-circle"
                    alt="Avatar image">
            @endif
            ...
            <div>
                ...
                <a href="{{ URL::to('company/profile') }}" target="_blank"><span
    ...
    <ul class="sidebar-menu">
        @if (Auth::user()->verification_status == 1 &&
                Auth::user()->profile_completion_status == 1 &&
            ...
            <li class="nav-item {{ request()->is('company/rewards') ? 'active current' : '' }}">
                <a href="{{ url('company/rewards') }}"> <i class="fa fa-gift" aria-hidden="true"></i>
                    {{ __t('Rewards') }} </a>
            </li>
            ...
            <li class="">
                <a href="#!">
                    ...
                    <span data-toggle="tooltip" data-placement="right" title="">Organization
                        Structure</span>
                    <!--  Remove this after development -->
                    <i class="chevron">
                ...
                <ul class="sidebar-submenu" style="display: none;">
                    ...
                    @if (Auth::user()->user_type == 'company')
                        <li>
                            <a href="{{ route('sub-contractor') }}">
                                <i aria-hidden="true"></i>

                                <span data-toggle="tooltip" data-placement="right"
                                    title="">Contractor</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('project-manager') }}">
                                <i aria-hidden="true"></i>

                                <span data-toggle="tooltip" data-placement="right" title="">Project
                                    Manager</span>
                            </a>
                        </li>
                    @endif
          ...
          <a href="#!">
            ...
            <li class="">
                <a href="#!">
                    ...
                    <!--  Uncomment this when working -->
                    <!--  Remove this after development -->
                    <span data-toggle="tooltip" data-placement="right" title="">Course
                        Management</span>
                    <!--  Remove this after development -->
                    <i class="chevron">
                        <svg fill="#ffffff" viewBox="0 0 1024 1024">
                ...
                <ul class="sidebar-submenu" style="display: none;">
                    ...
                    <li class="{{ request()->is('company/search-courses') ? 'active current' : '' }}">
                        <a href="{{ route('search-courses') }}">
                            <span data-toggle="tooltip" data-placement="right" title="">Search
                                Courses</span>
                    ...
                    <li
                        class="{{ request()->is('company/purchased-courses') ? 'active current' : '' }}">
                        <a href="{{ route('purchased-courses') }}">
                            <span data-toggle="tooltip" data-placement="right" title="">Purchased
                                Courses</span>
                    ...
                    <li class="{{ request()->is('company/enrolled-courses') ? 'active current' : '' }}">
                        <a href="{{ route('company-enrolled-course') }}">
                            <span data-toggle="tooltip" data-placement="right" title="">Enrolled
                                Courses</span>
                    ...
                    <li>
                        <a href="{{ route('certificate-view') }}">
                            <span data-toggle="tooltip" data-placement="right"
                                title="">Certificates</span>

                        </a>
                    </li>
                    <li>
                        <a href="{{ route('exam-result') }}">
                            <span data-toggle="tooltip" data-placement="right" title="">Exam
                                Results</span>
            ...
            <li>
                <a href="#!">
                    ...
                    <!--  Uncomment this when working -->
                    <!--  Remove this after development -->
                    <span data-toggle="tooltip" data-placement="right" title="">Training
                        Matrix</span>
                    <!--  Remove this after development -->
                    <i class="chevron">
                        <svg fill="#ffffff" viewBox="0 0 1024 1024">
                ...
                <ul class="sidebar-submenu" style="display: none;">
                    <li
                        class="{{ request()->is('company/training-matrix-structure') ? 'active current' : '' }}">
          ...
          <a href="{{ route('bidding')}}"   >
            ...
            @if (Auth::user()->user_type == 'company')
                <li>
                    <a href="#!">
                        <i class="fa fa-cube" aria-hidden="true"></i>
                        <span data-toggle="tooltip" data-placement="right" title="">Bidding
                            Management</span>
                        <!--  Remove this after development -->
                        <i class="chevron">
                            <svg fill="#ffffff" viewBox="0 0 1024 1024">
                    ...
                    <ul class="sidebar-submenu" style="display: none;">
                        <li
                            class="{{ request()->is('company/bidding-list') ? 'active current' : '' }}">
                            <a href="{{ route('bidding_list') }}">
                                <i aria-hidden="true"></i>
                                <span data-toggle="tooltip" data-placement="right"
                                    title="">Bidding Result</span>
                            </a>
                        </li>
                        @if (Auth::user()->user_type == 'company')
                            <li
                                class="{{ request()->is('company/bidding-request-list') ? 'active current' : '' }}">
                                <a href="{{ route('bidding_request_list') }}">
                                    <i aria-hidden="true"></i>
                                    <span data-toggle="tooltip" data-placement="right" title="">
                                        Bidding Request from Project Manager</span>
                                </a>
                            </li>
                        @endif
                    </ul>
                ...
                <li>
                    <a href="{{ route('messages') }}">
                        ...
                        <span data-toggle="tooltip" data-placement="right"
                            title="">Message</span>
                        @if (unreadMessages())
                            <span class='badge badge-warning hide-count float-right'>
                                {{ unreadMessages() }} </span>
                        @endif
                        <!--  Remove this after development -->
                    </a>
            ...
            <li>
                <a>
                    ...
                    <!--  Remove this after development -->
                    <span data-toggle="tooltip" data-placement="right" title="">Contact :
                        @if (contactSupport())
            ...
            <li>
                @if (contactSupport())
                    <a href="mailto:{{ contactSupport()->option_value }}?Subject=neew%20support"
                        class="btn btn-primary" style="font-size:smaller;"target="_blank"> Support
                    </a>
                @endif
            </li>

...
<head>
    ...
    {{-- Dark Mode --}}
    <link rel="stylesheet" href="{{ asset('assets/css/dark-mode-company.css') }}">
    <!-- Fontawesome -->
    <link rel="stylesheet"
        ...
        <main class="main-content">
            ...
            <div class="page-container">
                ...
                <div class="navigation-wrapper">
                    <nav class="navbar navbar-top navbar-expand-lg navbar-light adxs bg-white">
                        ...
                        z-index: 9;">
                            ...
                            <button
                                class="navbar-toggler navbar-toggler-css-reverse navbar-menu-toggler collapsed"
                        ...
                        <div class="container-fluid">
                            ...
                            <ul class="navbar-nav navbar-menu-primary">
                                ...
                                <li class="nav-item dropdown language-dropdown">
                                    ...
                                    <a href="#" class="nav-link dropdown-toggle dropdown-nocaret"
                                        role="button" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                        <img src="{{ asset('users/assets/layouts/flags/') . '/' . $flag }}"
                                            alt="">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-sm dropdown-menu-left"
                                        id="langDv">
                                        <a href="#" class="dropdown-item" id="english"
                                            @click="select_Lang('english')">
                                            <img src="{{ asset('users/assets/layouts/flags/us.svg') }}"
                                                alt="">
                                            English
                                        </a>
                                        <a href="#" class="dropdown-item" id="arabic"
                                            @click="select_Lang('arabic')">
                                            <img src="{{ asset('users/assets/layouts/flags/ar.svg') }}"
                                                alt="">
                                            Arabic
                                        </a>
                                    </div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link fs20" href="{{ route('home') }}"
                                        target="_blank" data-toggle="tooltip"
                                        data-original-title="{{ __a('site_home') }}"><i
                                ...
                                <li class="nav-item nav-user-dropdown dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-sm dropdown-menu-left"
                                        ...
                                        <div class="dropdown-header pt-0">
                                            <small class="text-overflow m-0">Welcome
                                                {{ Auth::user()->name }}</small>
                                        </div>
                                        <a href="{{ route('company-profile') }}" target="_blank"
                                            class="dropdown-item">
                                            <i class="fas fa-users"></i>
                                            <span>Profile</span>
                                        </a>
                                        <a href="{{ url('logout') }}" class="dropdown-item"
                                            id="logoutBtn" @click="logoutFn()">

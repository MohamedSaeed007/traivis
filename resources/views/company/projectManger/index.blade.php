            ...
            <div class="row">
                <div class="col-md-12 mb-3 ">
                    <i class="float-right far fa-question-circle" style="color: grey ; font-size:30px" data-toggle="tooltip"
                        data-placement="bottom" title="You can make a sub account who have all privileges as company except company basic details management."></i>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group text-right mr20">
                        <a class="btn btn-primary" href="{{ url('register?type=project-manager') }}"><i

                    ...
                    <div class="d-table">
                        <div class="d-table-cell">
                            <div class="login-form">
                                <div class="logo">
                                    <a href="{{ URL::to('/') }}"><img src="{{asset('assets/img/black-logo.png')}}"
                                                                      alt="image"></a>
                                </div>
                                ...
                                <form class="form-horizontal" role="form" method="POST"
                                      action="{{ secure_url(route('register')) }}">
                                    {{ csrf_field() }}

                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                                <label for="name" class="control-label ml20"><i class="fa fa-user"
                                                                                                aria-hidden="true"></i> {{__t('name')}}
                                                </label>

                                                <div>
                                                    <input id="name" type="text" class="form-control shadow2"
                                    ...
                                    <strong>{{ $errors->first('name') }}</strong>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                                <label for="email" class="control-label ml20"><i class="fa fa-envelope"
                                                                                                 aria-hidden="true"></i> {{__t('email_address')}}
                                                </label>

                                                <div>
                                                    <input id="email" type="email" class="form-control shadow2"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                                                <label for="password" class="control-label ml20"><i class="fa fa-eye"
                                                                                                    aria-hidden="true"></i> {{__t('password')}}
                                                </label>

                                                <div>
                                                    <input id="password" type="password" class="form-control shadow2"
    ...
    color: #be0303;">{!! $errors->first('password') !!}</strong>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="password-confirm" class="control-label ml20"><i
                                                            class="fa fa-eye"
                                                            aria-hidden="true"></i> {{__t('confirm_password')}}</label>

                                                <div>
                                                    <input id="password-confirm" type="password"
                                                           class="form-control shadow2" name="password_confirmation"
                                                           required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12" style="margin-bottom:20px;">
                                                <button type="submit"
                                                        class="btn btn-primary btn-block"> {{__t('register')}} </button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div id="particles-js-circle-bubble-3">
                        <canvas class="particles-js-canvas-el" width="1898" height="820"
...
<div class="form-group">
    ...
    <input type="hidden" name="user_as" value="@if($userType)
        {{ $userType }}
    @endif"

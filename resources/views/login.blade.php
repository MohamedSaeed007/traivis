                    ...
                    <div class="">
                        <form method="POST"
                            ...
                            <div class="relative group ">
                                <input class="{{ $errors->has('email') ? 'border-red-500 focus-within:border-red-500 active:border-red-500' : 'border-gray-300 focus-within:border-traivis-500 active:border-traivis-500' }} border w-full outline-none  bg-white px-4 py-1 rounded-full focus-within:ring-traivis-500 focus-within:ring-1  transition-colors text-l font-bold h-10 px-2  rounded-full mt-1 sm:truncate   transition-colors peer"
                            ...
                            <div class="mt-3">
                                <div class="py-2" x-data="{ show: false }">
                                    <div>
                                        <div class="relative group">
                                            <input class="{{ $errors->has('password') ? 'border-red-500 focus-within:border-red-500 active:border-red-500' : 'border-gray-300 focus-within:border-traivis-500 active:border-traivis-500' }} w-full outline-none border bg-white px-4 py-1 rounded-full focus-within:ring-traivis-500 focus-within:ring-1 transition-colors text-l font-bold h-10 px-2  rounded-full mt-1 sm:truncate transition-colors peer"
                                ...
                                <div>
                                    <div class="flex justify-between">
                                        <label class="block text-gray-500 font-bold my-4">
                                            <input type="checkbox"
                                                   class="leading-loose text-traivis-500 rounded-sm" {{ old('remember') ? 'checked' : '' }}>
                                            <span class="py-2 text-sm text-gray-600 leading-snug mx-2">
                                                  {{ __('Remember Me') }}
                                              </span>
                                        </label>
                                        <label class="block text-gray-500 font-bold my-4">
                                            <a href="{{ route('forgot_password') }}"
                                               class="text-sm text-gray-400 focus:text-traivis-500 hover:text-traivis-500 hover:underline">
                                                  <span>
                                    ...
                                    <div class="mt-6">
                                        ...
                                        class=" w-full transition inline-flex flex justify-center items-center px-3.5 py-2 border border-transparent text-sm leading-4 font-medium rounded-full shadow-sm space-x-2 text-white bg-traivis-500 hover:bg-traivis-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-traivis-500">
                                            {{ __('Login') }}
                                        </button>
                                    </div>
                                </div>
                        ...
                        <p class="mt-6 text-sm text-center text-gray-400">Don&#x27;t have an account yet ? <a
                                    href="{{ url('register/student') }}"
                                    class="text-traivis-500 focus:outline-none focus:underline hover:underline">Sign up</a>
                        </p>
                    </div>
                    <!--/Form-->
                </div>

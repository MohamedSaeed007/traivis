...
@section('content')
    ...
    @php
        ...
        $subAdminCount = \App\Models\User::whereUserType('sub-admin')->count();
        $companyUserCount = \App\Models\User::where('user_type','company')->count();
        ...
        $totalEnrol = \App\Models\CourseUser::whereStatus('success')->count();
        ...
        $notification = \App\Models\UserNotification::where('notifiable_user_id',Auth::user()->id)->orderBy('id','desc')->limit(5)->get();

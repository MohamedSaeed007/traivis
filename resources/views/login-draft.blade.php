        ...
        <div class="row m-0">
            ...
            <div class="col-lg-6 col-md-12 p-0">
                <div class="login-content">
                    <div class="d-table">
                        <div class="d-table-cell">
                            <div class="login-form">
                                <div class="logo">
                                    <a href="index.html"><img src="assets/img/black-logo.png"
                                            alt="image"></a>
                                </div>
                                ...
                                <form method="POST"
                                    action="{{ route('login', ['_redirect_back_to' => request()->get('_redirect_back_to')]) }}">
                                    @csrf

                                    <div class="form-group">
                                        <label for="email" class="col-form-label"
                                            style="margin-left:18px;"><i class="fa fa-envelope"
                                                aria-hidden="true"></i> {{ __('E-Mail Address') }}</label>

                                        <div class="col-md-12">
                                            <input id="email" type="email"
                                                class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }} shadow2"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="password" type="password"
                                                class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }} shadow2"
                    ...
                    <div id="particles-js-circle-bubble-3"><canvas class="particles-js-canvas-el"
                            width="1898" height="820" style="width: 100%; height: 100%;"></canvas></div>

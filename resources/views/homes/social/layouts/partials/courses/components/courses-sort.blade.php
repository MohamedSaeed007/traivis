...
<div
        id="sortCourses"
        x-data="{open:false,selected:'Newest', sortOptions:@entangle('sortOptions')}"
>
    <div class="relative w-48">
        ...
        >
            <span class="block truncate"> {{__('Sort by')}} <span x-text="selected"></span></span>
        ...
        <ul
                ...
                x-show="open"
                x-cloak
                class="absolute z-20 mt-1 w-full bg-white shadow-lg max-h-60 rounded-b-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm"
            ...
            <template x-for="sortOption in sortOptions" :key="index">
                <li
                    ...
                    -->
                    <span class="text-traivis-600 group:hover:text-white group:hover:fill-white absolute inset-y-0 left-0 flex items-center pl-1.5">

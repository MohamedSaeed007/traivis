<nav aria-label="Sidebar" class="{{-- md:bg-gray-800 --}} hidden md:block md:flex-shrink-0 md:overflow-y-auto z-[15]">
    <div class="sticky top-0 overflow-hidden flex flex-col p-3 w-20 border-r border-gray-300 h-screen bg-white flex-shrink-0">
        <a href="#"
